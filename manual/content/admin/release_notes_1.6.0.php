...
$LP_RELEASE_PAGE = 'https://launchpad.net/xibo/1.6/1.6.0';
?>
<h1 id="Notes_Title">Xibo 1.6.0 - Codename "Pons-Winnecke"</span></h1>
<p><strong>This is the first stable release of the 1.6 Series of Xibo</strong>.</p>
...
<p>You must use the 1.6.0 version of the Windows and Ubuntu Display Clients with this version of the Xibo CMS.</p>
...
<p>This release contains all of the new features from 1.5 and the 1.6 release candidates. This is a major step forward in terms of functionality in the CMS and display clients. For a complete list you can see the release notes of the previous versions.</p>
