...
class DataSetViewWidgetTestCase extends WidgetTestCase
{
    ...
    public function testEdit()
    {
        ...
        $dataSetViewCheck = (new XiboWidget($this->getEntityProvider()))->getById($region->playlists[0]['playlistId']);
        ...
        $nameNew = 'Edited Name';
        $durationNew = 80;
        $response = $this->client->put('/playlist/widget/' . $dataSetViewCheck->widgetId, [
        ...
        public function testDelete()
    {
        ...
        $dataSetViewCheck = (new XiboWidget($this->getEntityProvider()))->getById($region->playlists[0]['playlistId']);
        # Delete it
        $this->client->delete('/playlist/widget/' . $dataSetViewCheck->widgetId);
