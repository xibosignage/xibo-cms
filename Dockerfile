...
ADD ./docker/mod_xsendfile/mod_xsendfile.c /mod_xsendfile.c
...
ADD ./docker/mpm_prefork.conf /etc/apache2/conf.d/mpm.conf
...
ADD ./docker/settings.php-template /var/www/cms/web/settings.php
ADD ./docker/settings.php-template /tmp/settings.php-template
ADD ./docker/ssmtp.conf /etc/ssmtp/ssmtp.conf
ADD ./docker/settings-custom.php /tmp/settings-custom.php
...
COPY ./docker/anacron /etc/cron.d/anacron
