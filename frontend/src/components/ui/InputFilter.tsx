  ...
  return (
    ...
    >
      ...
      <input
        ...
        className="w-full h-11.25 bg-white rounded-lg border border-gray-200 px-4 text-left text-gray-700 focus:outline-none focus:ring-2 focus:ring-xibo-blue-500/20 focus:border-xibo-blue-500 transition-all"
      />
    </div>
  );
}
