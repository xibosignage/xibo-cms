...
export default function AboutModal({ isOpen = true, onClose }: AboutModalProps) {
  ...
  useEffect(() => {
    fetch('/about/config')
      ...
      .catch(() => {
        // Fallback: leave config null — default content renders
      })
          ...
          <>
            ...
            {appName === 'Xibo' && (
              <section>
                ...
                <p className="">
                  Feedback can be submitted via the help button and feedback forms contained within
                  the CMS. Feedback helps us improve our products and services. When you submit
                  feedback, we collect your name and email address, along with your comments and any
                  attachments. This information is used and stored in accordance with our{' '}
                  <a
                    href="https://xibosignage.com/privacy"
                    className="text-blue-600 hover:underline"
                  >
                    privacy policy
                  </a>{' '}
