...
export function AboutModalContent() {
  ...
  if (aboutText) {
    return <div dangerouslySetInnerHTML={{ __html: aboutText }} />;
  }
  ...
  return (
    <>
      ...
      <section>
        ...
        <p>
          As an end user of the Xibo software you are entitled to download and view the source code.
          You may do so from{' '}
          <a
            target="_blank"
            rel="noreferrer"
      ...
      {appName === 'Xibo' && (
        <section>
          ...
          <p>
            ...
            collect your name and email address, along with your comments and any attachments. This
            information is used and stored in accordance with our{' '}
