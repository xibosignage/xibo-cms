      ...
      <SettingsSection title={t('Email')}>
        <div className="flex items-start justify-between space-x-4">
          ...
          {isVisible('mail_from') && (
            <TextInput
              name="mail_from"
              label={t('Sending email address')}
              helpText={t('Mail will be sent from this address')}
      ...
      <SettingsSection title={t('Proxy')}>
        ...
        <div className="flex items-start justify-between space-x-4">
          {isVisible('PROXY_AUTH') && (
            <TextInput
              name="PROXY_AUTH"
              label={t('Proxy Credentials')}
              helpText={t('The Authentication information for this proxy. username:password')}
        ...
        <div className="flex items-start justify-between space-x-4">
          {isVisible('MONTHLY_XMDS_TRANSFER_LIMIT_KB') && (
            <NumberInput
              ...
              label={t('Monthly bandwidth Limit')}
              helpText={t('XMDS Transfer Limit in KB/month')}
          ...
          {isVisible('LIBRARY_SIZE_LIMIT_KB') && (
            <NumberInput
              ...
              label={t('Library Size Limit')}
              helpText={t('The Limit for the Library Size in KB')}
