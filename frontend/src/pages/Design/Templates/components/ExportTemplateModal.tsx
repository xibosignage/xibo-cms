...
export default function ExportTemplateModal({
  ...
  useEffect(() => {
    if (templateName) {
      setFileName(`export_${templateName}`);
    }
  }, [templateName]);
  ...
  return (
    ...
    >
      <div className="flex flex-col p-5 gap-3">
        ...
        <h2 className="text-lg font-semibold text-gray-800 text-center">{t('Export Template')}</h2>

        <p className="text-gray-500 text-center">
          {t(
            'The downloaded ZIP file will include the template, widgets, media, and associated DataSet structures.',
          )}
        </p>
        ...
        <Checkbox
          ...
          label={t('Include fallback content added to Widgets within this Template.')}
