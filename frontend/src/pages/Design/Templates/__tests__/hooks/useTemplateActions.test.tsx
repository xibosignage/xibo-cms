...
describe('useTemplateActions - handleConfirmMove', () => {
  ...
  it('moves all items and shows success notification', async () => {
    ...
    const itemsToMove = [
      { ...mockTemplate, campaignId: 1 },
      { ...mockTemplate, campaignId: 2 },
    ];
  ...
  it('shows error notification when all moves fail', async () => {
    ...
    await act(async () => {
      await result.current.handleConfirmMove([{ ...mockTemplate, campaignId: 1 }], 10);
    });
