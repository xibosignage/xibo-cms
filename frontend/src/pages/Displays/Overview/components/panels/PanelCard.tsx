...
export function PanelCard({
  ...
  return (
    <div className={twMerge('rounded-lg border border-gray-200 overflow-hidden', className)}>
      <div
        className={twMerge(
          'bg-gray-50 px-4 py-2.5 border-b border-gray-200 flex items-center justify-between gap-3',
          headerClassName,
        )}
      >
      ...
      <div className={twMerge('overflow-x-auto', bodyClassName)}>{children}</div>
    </div>
  );
}
