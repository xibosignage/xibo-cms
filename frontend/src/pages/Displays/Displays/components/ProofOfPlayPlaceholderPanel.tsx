...
// full report in the meantime. Collapsible so it doesn't permanently eat
// vertical space above the grid/table on the list page.
    ...
    <div className="rounded-lg border border-blue-100 bg-blue-50/60 p-4">
      <div className="flex items-center justify-between gap-3">
        <button
          ...
          className="flex items-center gap-1.5 text-sm font-semibold text-gray-700 cursor-pointer"
        >
          <ChevronDown
            className={twMerge(
