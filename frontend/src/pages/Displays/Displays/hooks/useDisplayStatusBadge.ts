...
// Status badge + thumbnail derivation for DisplayCard's card-style status
// display. Non-component cell renderers call getDisplayStatusInfo directly
// instead, since they can't call hooks.
