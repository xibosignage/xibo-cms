...
interface DeleteDisplayGroupModalProps {
  isOpen?: boolean;
  onClose: () => void;
  onDelete: () => void;
  itemCount: number;
...
export default function DeleteDisplayGroupModal({
  isOpen = true,
  onClose,
  onDelete,
  displayGroupName,
      ...
      <div className="flex flex-col p-5 gap-3">
        <div>
          ...
          <h2 className="text-center text-lg font-semibold mb-2 text-red-800">
            {itemCount === 1 ? t('Delete Display Group?') : t('Delete Display Groups?')}
          </h2>
        </div>
