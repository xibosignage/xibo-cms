...
export const DISPLAY_CATEGORY_REPORTS = [
  { label: 'Time Connected', url: null },
  { label: 'Time Connected Summary', url: '/report/form/timedisconnectedsummary' },
  { label: 'Display Statistics: Bandwidth', url: '/report/form/bandwidth' },
  { label: 'Display Alerts', url: '/report/form/displayalerts' },
];
