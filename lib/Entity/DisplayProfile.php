    ...
    private function loadForType()
    {
        $config = array(
            ...
            'android' => [
                ...
                ['name' => 'statsEnabled', 'default' => (int)$this->configService->getSetting('DISPLAY_PROFILE_STATS_DEFAULT', 0)],
                ['name' => 'orientation', 'default' => 0],
                ['name' => 'screenDimensions', 'default' => null],
                ['name' => 'blacklistVideo', 'default' => 1],
                ['name' => 'storeHtmlOnInternal', 'default' => 0],
                ['name' => 'useSurfaceVideoView', 'default' => 1],
                ['name' => 'logLevel', 'default' => 'error'],
                ['name' => 'versionMediaId', 'default' => null],
                ['name' => 'startOnBoot', 'default' => 1],
                ['name' => 'actionBarMode', 'default' => 1],
                ['name' => 'actionBarDisplayDuration', 'default' => 30],
                ['name' => 'actionBarIntent', 'default' => null],
                ['name' => 'autoRestart', 'default' => 1],
                ['name' => 'startOnBootDelay', 'default' => 60],
                ['name' => 'sendCurrentLayoutAsStatusUpdate', 'default' => 0],
                ['name' => 'screenShotRequestInterval', 'default' => 0],
                ['name' => 'expireModifiedLayouts', 'default' => 0],
                ...
                ['name' => 'installWithLoadedLinkLibraries', 'default' => 1],
            ],
            'linux' => [
                ['name' => 'collectInterval', 'default' => 300],
                ['name' => 'downloadStartWindow', 'default' => '00:00'],
                ...
                ['name' => 'logLevel', 'default' => 'error'],
                ['name' => 'enableShellCommands', 'default' => 0],
                ['name' => 'expireModifiedLayouts', 'default' => 0],
