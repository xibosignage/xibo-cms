...
//    }
     ...
     * @param bool $cmsConnected
     * @return array|null
     * @throws GeneralException
     * @throws GuzzleException
     * @throws InvalidArgumentException
     */
    public function getRdmDevices(bool $cmsConnected = false): ?array
    {
        ...
        try {
            ...
            $this->devices = json_decode($data, true);;
        } catch (RequestException $e) {
     ...
     */
    public function getAvailableDevicesFilter(SanitizerInterface $params): array
    {
