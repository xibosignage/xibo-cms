    ...
    public function update(Request $request, Response $response): Response
    {
        ...
        if ($this->getConfig()->isSettingEditable('LIBRARY_MEDIA_UPDATEINALL_CHECKB')) {
            $this->handleChangedSettings(
                ...
                $sanitizedParams->getCheckbox('LIBRARY_MEDIA_UPDATEINALL_CHECKB'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'LIBRARY_MEDIA_UPDATEINALL_CHECKB',
        ...
        if ($this->getConfig()->isSettingEditable('LAYOUT_COPY_MEDIA_CHECKB')) {
            $this->handleChangedSettings(
                ...
                $sanitizedParams->getCheckbox('LAYOUT_COPY_MEDIA_CHECKB'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'LAYOUT_COPY_MEDIA_CHECKB',
        ...
        if ($this->getConfig()->isSettingEditable('LIBRARY_MEDIA_DELETEOLDVER_CHECKB')) {
            $this->handleChangedSettings(
                ...
                $sanitizedParams->getCheckbox('LIBRARY_MEDIA_DELETEOLDVER_CHECKB'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'LIBRARY_MEDIA_DELETEOLDVER_CHECKB',
        ...
        if ($this->getConfig()->isSettingEditable('DEFAULT_LAYOUT_AUTO_PUBLISH_CHECKB')) {
            $this->handleChangedSettings(
                'DEFAULT_LAYOUT_AUTO_PUBLISH_CHECKB',
                $sanitizedParams->getCheckbox('DEFAULT_LAYOUT_AUTO_PUBLISH_CHECKB'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'DEFAULT_LAYOUT_AUTO_PUBLISH_CHECKB',
        ...
        if ($this->getConfig()->isSettingEditable('DEFAULT_TRANSITION_IN')) {
            $this->handleChangedSettings(
                ...
                $sanitizedParams->getString('DEFAULT_TRANSITION_IN'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'DEFAULT_TRANSITION_IN',
        ...
        if ($this->getConfig()->isSettingEditable('DEFAULT_TRANSITION_OUT')) {
            $this->handleChangedSettings(
                ...
                $sanitizedParams->getString('DEFAULT_TRANSITION_OUT'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'DEFAULT_TRANSITION_OUT',
        ...
        if ($this->getConfig()->isSettingEditable('DEFAULT_TRANSITION_DURATION')) {
            $this->handleChangedSettings(
                ...
                $sanitizedParams->getInt('DEFAULT_TRANSITION_DURATION'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'DEFAULT_TRANSITION_DURATION',
        ...
        if ($this->getConfig()->isSettingEditable('DEFAULT_TRANSITION_AUTO_APPLY')) {
            $this->handleChangedSettings(
                'DEFAULT_TRANSITION_AUTO_APPLY',
                $sanitizedParams->getCheckbox('DEFAULT_TRANSITION_AUTO_APPLY'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'DEFAULT_TRANSITION_AUTO_APPLY',
        ...
        if ($this->getConfig()->isSettingEditable('DEFAULT_RESIZE_THRESHOLD')) {
            $this->handleChangedSettings(
                ...
                $sanitizedParams->getInt('DEFAULT_RESIZE_THRESHOLD'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'DEFAULT_RESIZE_THRESHOLD',
        ...
        if ($this->getConfig()->isSettingEditable('DEFAULT_RESIZE_LIMIT')) {
            $this->handleChangedSettings(
                ...
                $sanitizedParams->getInt('DEFAULT_RESIZE_LIMIT'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'DEFAULT_RESIZE_LIMIT',
        ...
        if ($this->getConfig()->isSettingEditable('DATASET_HARD_ROW_LIMIT')) {
            $this->handleChangedSettings(
                ...
                $sanitizedParams->getInt('DATASET_HARD_ROW_LIMIT'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'DATASET_HARD_ROW_LIMIT',
        ...
        if ($this->getConfig()->isSettingEditable('DEFAULT_PURGE_LIST_TTL')) {
            $this->handleChangedSettings(
                'DEFAULT_PURGE_LIST_TTL',
                $sanitizedParams->getInt('DEFAULT_PURGE_LIST_TTL'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'DEFAULT_PURGE_LIST_TTL',
        ...
        if ($this->getConfig()->isSettingEditable('DEFAULT_LAYOUT')) {
            $this->handleChangedSettings(
                'DEFAULT_LAYOUT',
                $sanitizedParams->getInt('DEFAULT_LAYOUT'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'DEFAULT_LAYOUT',
        ...
        if ($this->getConfig()->isSettingEditable('XMR_ADDRESS')) {
            $this->handleChangedSettings(
                'XMR_ADDRESS',
                $sanitizedParams->getString('XMR_ADDRESS'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'XMR_ADDRESS',
        ...
        if ($this->getConfig()->isSettingEditable('XMR_PUB_ADDRESS')) {
            $this->handleChangedSettings(
                'XMR_PUB_ADDRESS',
                $sanitizedParams->getString('XMR_PUB_ADDRESS'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'XMR_PUB_ADDRESS',
        ...
        if ($this->getConfig()->isSettingEditable('XMR_WS_ADDRESS')) {
            $this->handleChangedSettings(
                'XMR_WS_ADDRESS',
                $sanitizedParams->getString('XMR_WS_ADDRESS'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'XMR_WS_ADDRESS',
        ...
        if ($this->getConfig()->isSettingEditable('DEFAULT_DYNAMIC_PLAYLIST_MAXNUMBER')) {
            $this->handleChangedSettings(
                ...
                $sanitizedParams->getInt('DEFAULT_DYNAMIC_PLAYLIST_MAXNUMBER'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'DEFAULT_DYNAMIC_PLAYLIST_MAXNUMBER',
        ...
        if ($this->getConfig()->isSettingEditable('DEFAULT_DYNAMIC_PLAYLIST_MAXNUMBER_LIMIT')) {
            $this->handleChangedSettings(
                ...
                $sanitizedParams->getInt('DEFAULT_DYNAMIC_PLAYLIST_MAXNUMBER_LIMIT'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'DEFAULT_DYNAMIC_PLAYLIST_MAXNUMBER_LIMIT',
        ...
        if ($this->getConfig()->isSettingEditable('SHOW_DISPLAY_AS_VNCLINK')) {
            $this->handleChangedSettings(
                ...
                $sanitizedParams->getString('SHOW_DISPLAY_AS_VNCLINK'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'SHOW_DISPLAY_AS_VNCLINK',
        ...
        if ($this->getConfig()->isSettingEditable('SHOW_DISPLAY_AS_VNC_TGT')) {
            $this->handleChangedSettings(
                ...
                $sanitizedParams->getString('SHOW_DISPLAY_AS_VNC_TGT'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'SHOW_DISPLAY_AS_VNC_TGT',
        ...
        if ($this->getConfig()->isSettingEditable('MAX_LICENSED_DISPLAYS')) {
            $this->handleChangedSettings(
                'MAX_LICENSED_DISPLAYS',
                $sanitizedParams->getInt('MAX_LICENSED_DISPLAYS'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'MAX_LICENSED_DISPLAYS',
        ...
        if ($this->getConfig()->isSettingEditable('DISPLAY_PROFILE_AGGREGATION_LEVEL_DEFAULT')) {
            $this->handleChangedSettings(
                'DISPLAY_PROFILE_AGGREGATION_LEVEL_DEFAULT',
                $sanitizedParams->getString('DISPLAY_PROFILE_AGGREGATION_LEVEL_DEFAULT'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'DISPLAY_PROFILE_AGGREGATION_LEVEL_DEFAULT',
        ...
        if ($this->getConfig()->isSettingEditable('DISPLAY_PROFILE_STATS_DEFAULT')) {
            $this->handleChangedSettings(
                'DISPLAY_PROFILE_STATS_DEFAULT',
                $sanitizedParams->getCheckbox('DISPLAY_PROFILE_STATS_DEFAULT'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'DISPLAY_PROFILE_STATS_DEFAULT',
        ...
        if ($this->getConfig()->isSettingEditable('LAYOUT_STATS_ENABLED_DEFAULT')) {
            $this->handleChangedSettings(
                'LAYOUT_STATS_ENABLED_DEFAULT',
                $sanitizedParams->getCheckbox('LAYOUT_STATS_ENABLED_DEFAULT'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'LAYOUT_STATS_ENABLED_DEFAULT',
        ...
        if ($this->getConfig()->isSettingEditable('PLAYLIST_STATS_ENABLED_DEFAULT')) {
            $this->handleChangedSettings(
                ...
                $sanitizedParams->getString('PLAYLIST_STATS_ENABLED_DEFAULT'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'PLAYLIST_STATS_ENABLED_DEFAULT',
        ...
        if ($this->getConfig()->isSettingEditable('MEDIA_STATS_ENABLED_DEFAULT')) {
            $this->handleChangedSettings(
                ...
                $sanitizedParams->getString('MEDIA_STATS_ENABLED_DEFAULT'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'MEDIA_STATS_ENABLED_DEFAULT',
        ...
        if ($this->getConfig()->isSettingEditable('WIDGET_STATS_ENABLED_DEFAULT')) {
            $this->handleChangedSettings(
                'WIDGET_STATS_ENABLED_DEFAULT',
                $sanitizedParams->getString('WIDGET_STATS_ENABLED_DEFAULT'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'WIDGET_STATS_ENABLED_DEFAULT',
        ...
        if ($this->getConfig()->isSettingEditable('DISPLAY_PROFILE_CURRENT_LAYOUT_STATUS_ENABLED')) {
            $this->handleChangedSettings(
                ...
                $sanitizedParams->getCheckbox('DISPLAY_PROFILE_CURRENT_LAYOUT_STATUS_ENABLED'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'DISPLAY_PROFILE_CURRENT_LAYOUT_STATUS_ENABLED',
        ...
        if ($this->getConfig()->isSettingEditable('DISPLAY_LOCK_NAME_TO_DEVICENAME')) {
            $this->handleChangedSettings(
                ...
                $sanitizedParams->getCheckbox('DISPLAY_LOCK_NAME_TO_DEVICENAME'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'DISPLAY_LOCK_NAME_TO_DEVICENAME',
        ...
        if ($this->getConfig()->isSettingEditable('DISPLAY_PROFILE_SCREENSHOT_INTERVAL_ENABLED')) {
            $this->handleChangedSettings(
                ...
                $sanitizedParams->getCheckbox('DISPLAY_PROFILE_SCREENSHOT_INTERVAL_ENABLED'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'DISPLAY_PROFILE_SCREENSHOT_INTERVAL_ENABLED',
        ...
        if ($this->getConfig()->isSettingEditable('DISPLAY_PROFILE_SCREENSHOT_SIZE_DEFAULT')) {
            $this->handleChangedSettings(
                'DISPLAY_PROFILE_SCREENSHOT_SIZE_DEFAULT',
                $sanitizedParams->getInt('DISPLAY_PROFILE_SCREENSHOT_SIZE_DEFAULT'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'DISPLAY_PROFILE_SCREENSHOT_SIZE_DEFAULT',
        ...
        if ($this->getConfig()->isSettingEditable('DISPLAY_SCREENSHOT_TTL')) {
            $this->handleChangedSettings(
                'DISPLAY_SCREENSHOT_TTL',
                $sanitizedParams->getInt('DISPLAY_SCREENSHOT_TTL'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'DISPLAY_SCREENSHOT_TTL',
        ...
        if ($this->getConfig()->isSettingEditable('DISPLAY_AUTO_AUTH')) {
            $this->handleChangedSettings(
                'DISPLAY_AUTO_AUTH',
                $sanitizedParams->getCheckbox('DISPLAY_AUTO_AUTH'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'DISPLAY_AUTO_AUTH',
        ...
        if ($this->getConfig()->isSettingEditable('HELP_BASE')) {
            $this->handleChangedSettings(
                'HELP_BASE',
                $sanitizedParams->getString('HELP_BASE'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'HELP_BASE',
        ...
        if ($this->getConfig()->isSettingEditable('QUICK_CHART_URL')) {
            $this->handleChangedSettings(
                'QUICK_CHART_URL',
                $sanitizedParams->getString('QUICK_CHART_URL'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'QUICK_CHART_URL',
        ...
        if ($this->getConfig()->isSettingEditable('PHONE_HOME')) {
            $this->handleChangedSettings(
                'PHONE_HOME',
                $sanitizedParams->getCheckbox('PHONE_HOME'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'PHONE_HOME',
        ...
        if ($this->getConfig()->isSettingEditable('PHONE_HOME_KEY')) {
            $this->handleChangedSettings(
                'PHONE_HOME_KEY',
                $sanitizedParams->getString('PHONE_HOME_KEY'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'PHONE_HOME_KEY',
        ...
        if ($this->getConfig()->isSettingEditable('PHONE_HOME_DATE')) {
            $this->handleChangedSettings(
                'PHONE_HOME_DATE',
                $sanitizedParams->getInt('PHONE_HOME_DATE'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'PHONE_HOME_DATE',
        ...
        if ($this->getConfig()->isSettingEditable('SCHEDULE_LOOKAHEAD')) {
            $this->handleChangedSettings(
                'SCHEDULE_LOOKAHEAD',
                $sanitizedParams->getCheckbox('SCHEDULE_LOOKAHEAD'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'SCHEDULE_LOOKAHEAD',
        ...
        if ($this->getConfig()->isSettingEditable('SETTING_LIBRARY_TIDY_ENABLED')) {
            $this->handleChangedSettings(
                ...
                $sanitizedParams->getCheckbox('SETTING_LIBRARY_TIDY_ENABLED'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'SETTING_LIBRARY_TIDY_ENABLED',
        ...
        if ($this->getConfig()->isSettingEditable('DEFAULTS_IMPORTED')) {
            $this->handleChangedSettings(
                'DEFAULTS_IMPORTED',
                $sanitizedParams->getCheckbox('DEFAULTS_IMPORTED'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'DEFAULTS_IMPORTED',
        ...
        if ($this->getConfig()->isSettingEditable('DASHBOARD_LATEST_NEWS_ENABLED')) {
            $this->handleChangedSettings(
                'DASHBOARD_LATEST_NEWS_ENABLED',
                $sanitizedParams->getCheckbox('DASHBOARD_LATEST_NEWS_ENABLED'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'DASHBOARD_LATEST_NEWS_ENABLED',
        ...
        if ($this->getConfig()->isSettingEditable('INSTANCE_SUSPENDED')) {
            $this->handleChangedSettings(
                'INSTANCE_SUSPENDED',
                $sanitizedParams->getString('INSTANCE_SUSPENDED'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'INSTANCE_SUSPENDED',
        ...
        if ($this->getConfig()->isSettingEditable('LATEST_NEWS_URL')) {
            $this->handleChangedSettings(
                'LATEST_NEWS_URL',
                $sanitizedParams->getString('LATEST_NEWS_URL'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'LATEST_NEWS_URL',
        ...
        if ($this->getConfig()->isSettingEditable('MAINTENANCE_ENABLED')) {
            $this->handleChangedSettings(
                'MAINTENANCE_ENABLED',
                $sanitizedParams->getString('MAINTENANCE_ENABLED'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'MAINTENANCE_ENABLED',
        ...
        if ($this->getConfig()->isSettingEditable('MAINTENANCE_EMAIL_ALERTS')) {
            $this->handleChangedSettings(
                ...
                $sanitizedParams->getCheckbox('MAINTENANCE_EMAIL_ALERTS'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'MAINTENANCE_EMAIL_ALERTS',
        ...
        if ($this->getConfig()->isSettingEditable('MAINTENANCE_LOG_MAXAGE')) {
            $this->handleChangedSettings(
                ...
                $sanitizedParams->getInt('MAINTENANCE_LOG_MAXAGE'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'MAINTENANCE_LOG_MAXAGE',
        ...
        if ($this->getConfig()->isSettingEditable('MAINTENANCE_STAT_MAXAGE')) {
            $this->handleChangedSettings(
                ...
                $sanitizedParams->getInt('MAINTENANCE_STAT_MAXAGE'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'MAINTENANCE_STAT_MAXAGE',
        ...
        if ($this->getConfig()->isSettingEditable('MAINTENANCE_ALERT_TOUT')) {
            $this->handleChangedSettings(
                ...
                $sanitizedParams->getInt('MAINTENANCE_ALERT_TOUT'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'MAINTENANCE_ALERT_TOUT',
        ...
        if ($this->getConfig()->isSettingEditable('MAINTENANCE_ALWAYS_ALERT')) {
            $this->handleChangedSettings(
                'MAINTENANCE_ALWAYS_ALERT',
                $sanitizedParams->getCheckbox('MAINTENANCE_ALWAYS_ALERT'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'MAINTENANCE_ALWAYS_ALERT',
        ...
        if ($this->getConfig()->isSettingEditable('mail_to')) {
            $this->handleChangedSettings(
                'mail_to',
                $sanitizedParams->getString('mail_to'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'mail_to',
        ...
        if ($this->getConfig()->isSettingEditable('mail_from')) {
            $this->handleChangedSettings(
                'mail_from',
                $sanitizedParams->getString('mail_from'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'mail_from',
        ...
        if ($this->getConfig()->isSettingEditable('mail_from_name')) {
            $this->handleChangedSettings(
                'mail_from_name',
                $sanitizedParams->getString('mail_from_name'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'mail_from_name',
        ...
        if ($this->getConfig()->isSettingEditable('SENDFILE_MODE')) {
            $this->handleChangedSettings(
                'SENDFILE_MODE',
                $sanitizedParams->getString('SENDFILE_MODE'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'SENDFILE_MODE',
        ...
        if ($this->getConfig()->isSettingEditable('PROXY_HOST')) {
            $this->handleChangedSettings(
                'PROXY_HOST',
                $sanitizedParams->getString('PROXY_HOST'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'PROXY_HOST',
        ...
        if ($this->getConfig()->isSettingEditable('PROXY_PORT')) {
            $this->handleChangedSettings(
                'PROXY_PORT',
                $sanitizedParams->getString('PROXY_PORT'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'PROXY_PORT',
        ...
        if ($this->getConfig()->isSettingEditable('PROXY_AUTH')) {
            $this->handleChangedSettings(
                'PROXY_AUTH',
                $sanitizedParams->getString('PROXY_AUTH'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'PROXY_AUTH',
        ...
        if ($this->getConfig()->isSettingEditable('PROXY_EXCEPTIONS')) {
            $this->handleChangedSettings(
                'PROXY_EXCEPTIONS',
                $sanitizedParams->getString('PROXY_EXCEPTIONS'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'PROXY_EXCEPTIONS',
        ...
        if ($this->getConfig()->isSettingEditable('CDN_URL')) {
            $this->handleChangedSettings(
                'CDN_URL',
                $sanitizedParams->getString('CDN_URL'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'CDN_URL',
        ...
        if ($this->getConfig()->isSettingEditable('MONTHLY_XMDS_TRANSFER_LIMIT_KB')) {
            $this->handleChangedSettings(
                ...
                $sanitizedParams->getInt('MONTHLY_XMDS_TRANSFER_LIMIT_KB'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'MONTHLY_XMDS_TRANSFER_LIMIT_KB',
        ...
        if ($this->getConfig()->isSettingEditable('LIBRARY_SIZE_LIMIT_KB')) {
            $this->handleChangedSettings(
                ...
                $sanitizedParams->getInt('LIBRARY_SIZE_LIMIT_KB'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'LIBRARY_SIZE_LIMIT_KB',
        ...
        if ($this->getConfig()->isSettingEditable('FORCE_HTTPS')) {
            $this->handleChangedSettings(
                'FORCE_HTTPS',
                $sanitizedParams->getCheckbox('FORCE_HTTPS'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'FORCE_HTTPS',
        ...
        if ($this->getConfig()->isSettingEditable('ISSUE_STS')) {
            $this->handleChangedSettings(
                'ISSUE_STS',
                $sanitizedParams->getCheckbox('ISSUE_STS'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'ISSUE_STS',
        ...
        if ($this->getConfig()->isSettingEditable('STS_TTL')) {
            $this->handleChangedSettings(
                'STS_TTL',
                $sanitizedParams->getInt('STS_TTL'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'STS_TTL',
        ...
        if ($this->getConfig()->isSettingEditable('WHITELIST_LOAD_BALANCERS')) {
            $this->handleChangedSettings(
                'WHITELIST_LOAD_BALANCERS',
                $sanitizedParams->getString('WHITELIST_LOAD_BALANCERS'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'WHITELIST_LOAD_BALANCERS',
        ...
        if ($this->getConfig()->isSettingEditable('REGION_OPTIONS_COLOURING')) {
            $this->handleChangedSettings(
                ...
                $sanitizedParams->getString('REGION_OPTIONS_COLOURING'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'REGION_OPTIONS_COLOURING',
        ...
        if ($this->getConfig()->isSettingEditable('SCHEDULE_WITH_VIEW_PERMISSION')) {
            $this->handleChangedSettings(
                ...
                $sanitizedParams->getCheckbox('SCHEDULE_WITH_VIEW_PERMISSION'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'SCHEDULE_WITH_VIEW_PERMISSION',
        ...
        if ($this->getConfig()->isSettingEditable('SCHEDULE_SHOW_LAYOUT_NAME')) {
            $this->handleChangedSettings(
                'SCHEDULE_SHOW_LAYOUT_NAME',
                $sanitizedParams->getCheckbox('SCHEDULE_SHOW_LAYOUT_NAME'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'SCHEDULE_SHOW_LAYOUT_NAME',
        ...
        if ($this->getConfig()->isSettingEditable('TASK_CONFIG_LOCKED_CHECKB')) {
            $this->handleChangedSettings(
                'TASK_CONFIG_LOCKED_CHECKB',
                $sanitizedParams->getCheckbox('TASK_CONFIG_LOCKED_CHECKB'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'TASK_CONFIG_LOCKED_CHECKB',
        ...
        if ($this->getConfig()->isSettingEditable('TRANSITION_CONFIG_LOCKED_CHECKB')) {
            $this->handleChangedSettings(
                'TRANSITION_CONFIG_LOCKED_CHECKB',
                $sanitizedParams->getCheckbox('TRANSITION_CONFIG_LOCKED_CHECKB'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'TRANSITION_CONFIG_LOCKED_CHECKB',
        ...
        if ($this->getConfig()->isSettingEditable('FOLDERS_ALLOW_SAVE_IN_ROOT')) {
            $this->handleChangedSettings(
                ...
                $sanitizedParams->getCheckbox('FOLDERS_ALLOW_SAVE_IN_ROOT'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'FOLDERS_ALLOW_SAVE_IN_ROOT',
        ...
        if ($this->getConfig()->isSettingEditable('DEFAULT_LANGUAGE')) {
            $this->handleChangedSettings(
                'DEFAULT_LANGUAGE',
                $sanitizedParams->getString('DEFAULT_LANGUAGE'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'DEFAULT_LANGUAGE',
        ...
        if ($this->getConfig()->isSettingEditable('defaultTimezone')) {
            $this->handleChangedSettings(
                'defaultTimezone',
                $sanitizedParams->getString('defaultTimezone'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'defaultTimezone',
        ...
        if ($this->getConfig()->isSettingEditable('DATE_FORMAT')) {
            $this->handleChangedSettings(
                'DATE_FORMAT',
                $sanitizedParams->getString('DATE_FORMAT'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'DATE_FORMAT',
        ...
        if ($this->getConfig()->isSettingEditable('DETECT_LANGUAGE')) {
            $this->handleChangedSettings(
                'DETECT_LANGUAGE',
                $sanitizedParams->getCheckbox('DETECT_LANGUAGE'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'DETECT_LANGUAGE',
        ...
        if ($this->getConfig()->isSettingEditable('CALENDAR_TYPE')) {
            $this->handleChangedSettings(
                'CALENDAR_TYPE',
                $sanitizedParams->getString('CALENDAR_TYPE'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'CALENDAR_TYPE',
        ...
        if ($this->getConfig()->isSettingEditable('RESTING_LOG_LEVEL')) {
            $this->handleChangedSettings(
                'RESTING_LOG_LEVEL',
                $sanitizedParams->getString('RESTING_LOG_LEVEL'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'RESTING_LOG_LEVEL',
        ...
        if ($this->getConfig()->isSettingEditable('audit')) {
            ...
            $this->handleChangedSettings('audit', $newLogLevel, $changedSettings);
        ...
        if ($this->getConfig()->isSettingEditable('SERVER_MODE')) {
            $this->handleChangedSettings(
                'SERVER_MODE',
                $sanitizedParams->getString('SERVER_MODE'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'SERVER_MODE',
        ...
        if ($this->getConfig()->isSettingEditable('SYSTEM_USER')) {
            $this->handleChangedSettings(
                'SYSTEM_USER',
                $sanitizedParams->getInt('SYSTEM_USER'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'SYSTEM_USER',
        ...
        if ($this->getConfig()->isSettingEditable('DEFAULT_USERGROUP')) {
            $this->handleChangedSettings(
                'DEFAULT_USERGROUP',
                $sanitizedParams->getInt('DEFAULT_USERGROUP'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'DEFAULT_USERGROUP',
        ...
        if ($this->getConfig()->isSettingEditable('defaultUsertype')) {
            $this->handleChangedSettings(
                'defaultUsertype',
                $sanitizedParams->getString('defaultUsertype'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'defaultUsertype',
        ...
        if ($this->getConfig()->isSettingEditable('USER_PASSWORD_POLICY')) {
            $this->handleChangedSettings(
                ...
                $sanitizedParams->getString('USER_PASSWORD_POLICY'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'USER_PASSWORD_POLICY',
        ...
        if ($this->getConfig()->isSettingEditable('USER_PASSWORD_ERROR')) {
            $this->handleChangedSettings(
                'USER_PASSWORD_ERROR',
                $sanitizedParams->getString('USER_PASSWORD_ERROR'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'USER_PASSWORD_ERROR',
        ...
        if ($this->getConfig()->isSettingEditable('PASSWORD_REMINDER_ENABLED')) {
            $this->handleChangedSettings(
                ...
                $sanitizedParams->getString('PASSWORD_REMINDER_ENABLED'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'PASSWORD_REMINDER_ENABLED',
        ...
        if ($this->getConfig()->isSettingEditable('TWOFACTOR_ISSUER')) {
            $this->handleChangedSettings(
                'TWOFACTOR_ISSUER',
                $sanitizedParams->getString('TWOFACTOR_ISSUER'),
                $changedSettings
            );
            $this->getConfig()->changeSetting(
                'TWOFACTOR_ISSUER',
        ...
        return $response->withStatus(200)->withJson(['message' => __('Settings Updated')]);
    }

    private function handleChangedSettings(string $setting, mixed $newValue, array &$changedSettings): void
    {
        ...
        if ($oldValue != $newValue) {
            if ($setting === 'SYSTEM_USER') {
                ...
                $this->getDispatcher()->dispatch(
                    new SystemUserChangedEvent($oldSystemUser, $newSystemUser),
                    SystemUserChangedEvent::$NAME
                );
            } elseif ($setting === 'DEFAULT_DYNAMIC_PLAYLIST_MAXNUMBER_LIMIT') {
                $this->getDispatcher()->dispatch(
                    new PlaylistMaxNumberChangedEvent($newValue),
                    PlaylistMaxNumberChangedEvent::$NAME
                );
            }
