...
$LP_RELEASE_PAGE = 'https://launchpad.net/xibo/1.7/1.7.0-alpha2';
?>
<h1>Xibo 1.7.0-alpha2 - Codename "Tuttle"</span></h1>
<p>This is a development preview release of Xibo. This release is the second of the development preview releases of Xibo working towards the release of Xibo 1.7.0, the next stable line of Xibo released. <strong>This should NOT BE USED IN PRODUCTION.</strong>.</p>
...
<p>This release builds on 1.7.0-alpha, optimizing the improvements already made, fixing bugs and adding a few additional features. The most notable new feature is support for custom fonts.</p>
...
<p>You must use the 1.7.0-alpha or higher version of the Windows Display Client with this version of the Xibo CMS. The Ubuntu Client is not currently compatible with 1.7 series.</p>
