...
$LP_RELEASE_PAGE = 'https://launchpad.net/xibo/1.6/1.6.4';
?>
<h1 id="Notes_Title">Xibo 1.6.4 - Codename "Pons-Winnecke"</span></h1>
<p><strong>This is a bug fixing release of the 1.6 Series of Xibo</strong>. We recommend everyone using 1.6 series upgrade to this release.</p>
...
<p>You must use the 1.6.4 version of the Windows Display Client and the latest Ubuntu Display Client with this version of the Xibo CMS.</p>
...
<p>There are significant database schema changes between the 1.6 series of Xibo and prior releases. The upgrade wizard will take a prior database and convert it to a schema suitable for the 1.6 series to date. Note that this is a one-way conversion. Please do not upgrade your production database to test Xibo 1.6 functionality, and then expect to run a prior series code base against that database.</p>
