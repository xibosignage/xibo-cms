	...
	<p>Playlists that span over a day in length, are denoted by a coloured bar. This
 	...
 	<p><?php echo PRODUCT_NAME; ?> supports scheduling more than one layout at once using Campaign. The client will automatically alternate 
  	...
  	<a name="Display Views" id="Display Views"></a><h3>Display Views</h3>
  	<p>The displays that are available for your selection are shown below the calendar month window.</p>

  	<p>Multiple displays may be selected. The Displays which are being selected, will have their scheduled events shown 
  	on the same month canlendar schedule chart. This allows you to change any display schedule that is selected and 
  	viewable to you.</p>
