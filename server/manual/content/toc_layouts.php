<div class="list-group">
	...
	<a class="list-group-item" href="index.php?toc=layouts&p=layout/campaign_layout">Campaign Layout</a>
	...
	<a class="list-group-item" href="index.php?toc=layouts&p=layout/content_microblog">Content - MicroBlog</a>
	...
	<a class="list-group-item" href="index.php?toc=layouts&p=templates/template_resolution">Template Resolution</a>
	<a class="list-group-item" href="index.php?toc=layouts&p=templates/choosetemplate">Choosing Template</a>
</div>