...
?>
<h1>Templates</h1>
<p>Templates allow a user to save a layouts generic properties so that it can be used to create the same layout with different content. Templates are optional.</p>
...
<p>Once added a template will be available on the Add Layout form.</p>