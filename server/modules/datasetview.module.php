...
FORM;
    ...
    public function EditForm()
    {
        ...
        $columns = Kit::ValidateParam($this->GetOption('columns'), _ARRAY);
        ...
        {
            $col = explode('|', $col);
            $columnsSelected .= '<li id="DataSetColumnId' . $col[0] . '"class="li-sortable">' . $col[1] . '</li>';
        }
        ...
        {
            $columnsNotSelected .= '<li id="DataSetColumnId' . $notCol['DataSetColumnID'] . '"class="li-sortable">' . $notCol['Heading'] . '</li>';
        }
