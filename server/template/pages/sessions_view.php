...
<?php
// Put a menu here
if (!$menu = new MenuManager($db, $user, 'Advanced Menu')) trigger_error($menu->message, E_USER_ERROR);
...
?>
	...
	<div id="form_body">
		<div class="SecondNav">
			...
			<ul>
				<li><a title="<?php echo $msgShowFilter; ?>" href="#" onclick="ToggleFilterView('SessionFilter')"><span><?php echo $msgFilter; ?></span></a></li>
			</ul>
		</div>
