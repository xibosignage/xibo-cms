...
<div class="row">
	<ul class="nav nav-pills span12">
		...
		?>
		<li class="pull-right"><a title="<?php echo Theme::Translate('Add a new Help page'); ?>" class="XiboFormButton" href="<?php echo Theme::Get('help_form_add_url'); ?>" ><span><?php echo Theme::Translate('Add Help Link'); ?></span></a></li>
	</ul>
</div>
<div class="row">
