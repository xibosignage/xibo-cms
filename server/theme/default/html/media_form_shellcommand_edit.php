...
<form id="<?php echo Theme::Get('form_id'); ?>" class="XiboForm form-horizontal" method="post" action="<?php echo Theme::Get('form_action'); ?>">
    ...
    <div class="row">
		<div class="control-group">
		    ...
		    <div class="controls">
		        <input class="" name="windowsCommand" type="text" id="windowsCommand" tabindex="1" value="<?php echo Theme::Get('windowsCommand'); ?>" />
		    </div>
		</div>
		<div class="control-group">
		    ...
		    <div class="controls">
		        <input class="" name="linuxCommand" type="text" id="linuxCommand" tabindex="1" value="<?php echo Theme::Get('linuxCommand'); ?>" />
		    </div>
		</div>
    </div>
</form>
