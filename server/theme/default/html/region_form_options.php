...
<form id="<?php echo Theme::Get('form_id'); ?>" class="XiboForm" method="post" action="<?php echo Theme::Get('form_action'); ?>">
	...
	<table>
        ...
        <tr>
            <td><label for="transitionType" title="<?php echo Theme::Translate('What transition should be applied when this region is finished?'); ?>"><?php echo Theme::Translate('Exit Transition'); ?></label></td>
            <td><?php echo Theme::SelectList('transitionType', Theme::Get('transition_field_list'), 'code', 'transition', Theme::Get('transition'), null, 'class'); ?></td>
        </tr>
        <tr class="transitionDuration">
            <td><label for="transitionDuration"><?php echo Theme::Translate('The duration for this transition, in milliseconds.'); ?></label></td>
            <td><input type="text" class="numeric" name="transitionDuration" id="transitionDuration" value="<?php echo Theme::Get('duration'); ?>" /></td>
        </tr>
        <tr class="transitionDirection">
            <td><label for="transitionDirection"><?php echo Theme::Translate('The direction for this transtion.'); ?></label></td>
            <td><?php echo Theme::SelectList('transitionDirection', Theme::Get('direction_field_list'), 'id', 'name', Theme::Get('direction')); ?></td>
        </tr>
    </table>
</form>