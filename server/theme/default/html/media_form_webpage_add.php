...
<form id="<?php echo Theme::Get('form_id'); ?>" class="XiboForm form-horizontal" method="post" action="<?php echo Theme::Get('form_action'); ?>">
    ...
    <div class="row">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input class="number" name="offsetTop" type="text" id="offsetTop" tabindex="3" />
            </div>
        </div>
        <div class="control-group">
            ...
            <div class="controls">
                <input class="number" name="offsetLeft" type="text" id="offsetLeft" tabindex="4" />
            </div>
        </div>
        <div class="control-group">
            ...
            <div class="controls">
                <input class="number" name="scaling" type="text" id="scaling" tabindex="5" />
            </div>
        </div>
        <div class="control-group">
            <div class="controls">
                <label class="checkbox" for="transparency" accesskey="n" title="<?php echo Theme::Translate('Background transparent?'); ?>"><?php echo Theme::Translate('Background transparent?'); ?>
                    <input class="" name="transparency" type="checkbox" id="transparency" tabindex="6" checked />
        		</label>
            </div>
        </div>
    </div>
