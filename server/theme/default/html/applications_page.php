...
<div id="form_container">
	...
	<div id="form_body">
		<div class="SecondNav">
			<ul>
				<li><a title="<?php echo Theme::Translate('Add an Application'); ?>" class="XiboFormButton" href="<?php echo Theme::Get('application_form_add_url'); ?>" ><span><?php echo Theme::Translate('Add Application'); ?></span></a></li>
				<li><a title="<?php echo Theme::Translate('View a log of application activity'); ?>" class="XiboFormButton" href="<?php echo Theme::Get('oauth_log_button_url'); ?>" ><span><?php echo Theme::Translate('oAuth Log'); ?></span></a></li>
			</ul>
		</div>
