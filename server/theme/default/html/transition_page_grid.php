...
<table class="table">
	...
	<tbody>
		...
		<tr>
			...
			<td><span class="<?php echo $row['hasduration_image']; ?>"></span></td>
			<td><span class="<?php echo $row['hasdirection_image']; ?>"></span></td>
			<td><span class="<?php echo $row['enabledforin_image']; ?>"></span></td>
			<td><span class="<?php echo $row['enabledforout_image']; ?>"></span></td>
			<td>
