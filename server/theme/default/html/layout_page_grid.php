			...
			<td>
				<div class="btn-group pull-right">
    				...
    				<ul class="dropdown-menu">
						...
						<li class="<?php echo ((($button['id'] == 'layout_button_design') || ($button['id'] == 'layout_button_preview') || ($button['id'] == 'layout_button_export')) ? 'XiboRedirectButton' : 'XiboFormButton'); ?>" href="<?php echo $button['url']; ?>" <?php echo (($button['id'] == 'layout_button_preview') ? ' target="_blank"' : ''); ?> ><a tabindex="-1" href="#"><?php echo $button['text']; ?></a></li>
						<?php } ?>
    				</ul>
  				</div>
			</td>
