        ...
        <div class="span6">
            <div class="control-group">
                <div class="controls">
                    ...
                    <label class="checkbox" for="wakeOnLanEnabled" accesskey="n" title="<?php echo Theme::Translate('Wake on Lan requires the correct network configuration to route the magic packet to the display PC'); ?>"><?php echo Theme::Translate('Enable Wake on LAN'); ?></label>
                </div>
            </div>
            <div class="control-group">
