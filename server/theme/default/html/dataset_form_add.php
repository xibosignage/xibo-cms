...
<form id="<?php echo Theme::Get('form_id'); ?>" class="XiboForm" method="post" action="<?php echo Theme::Get('form_action'); ?>">
	...
	<table>
		<tr>
			...
			<td><input class="required" name="dataset" type="text" id="dataset" tabindex="1" maxlength="50" /></td>
		</tr>
		<tr>
			...
			<td><input class="required" name="description" type="text" id="description" tabindex="1" maxlength="254" /></td>
		</tr>
	</table>
</form>
