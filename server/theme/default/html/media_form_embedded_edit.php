...
<form id="<?php echo Theme::Get('form_id'); ?>" class="XiboForm form-horizontal" method="post" action="<?php echo Theme::Get('form_action'); ?>">
    ...
    <div class="row">
        <div class="span4">
            ...
            <textarea class="wide_textarea" cols="80" rows="10" name="embedHtml"><?php echo Theme::Get('embedHtml'); ?></textarea>
        </div>
    </div>
    <div class="row">
        <div class="span4">
            <p class="text-info text-center"><?php echo Theme::Translate('HEAD content to Embed (including script tags)'); ?></p>
            <textarea class="wide_textarea" cols="80" rows="10" name="embedScript"><?php echo Theme::Get('embedScript'); ?></textarea>
        </div>
    </div>
</form>