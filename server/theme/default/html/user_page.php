...
<div id="form_container">
	...
	<div id="form_body">
		<div class="SecondNav">
			<ul>
				<li><a title="<?php echo Theme::Translate('Add a new Display Group'); ?>" class="XiboFormButton" href="<?php echo Theme::Get('user_form_add_url'); ?>" ><span><?php echo Theme::Translate('Add User'); ?></span></a></li>
