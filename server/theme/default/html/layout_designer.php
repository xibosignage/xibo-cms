	...
	<div class="span1">
		<div class="btn-group">
			...
			<ul class="dropdown-menu">
				...
				<li class="divider"></li>
                <li><a class="XiboFormButton" href="<?php echo Theme::Get('layout_form_preview_url'); ?>" title="<?php echo Theme::Translate('Preview Layout'); ?>" target="_blank"><span><?php echo Theme::Translate('Preview Layout'); ?></span></a></li>
