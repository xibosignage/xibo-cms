...
<div class="row">
	<ul class="nav nav-pills span12">
		...
		<li class="pull-right"><a title="<?php echo Theme::Translate('Add a new User Group'); ?>" class="XiboFormButton" href="<?php echo Theme::Get('usergroup_form_add_url'); ?>" ><span><?php echo Theme::Translate('Add User Group'); ?></span></a></li>
	</ul>
</div>
<div class="row">
