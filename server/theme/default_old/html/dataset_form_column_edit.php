...
<form id="<?php echo Theme::Get('form_id'); ?>" class="XiboForm" method="post" action="<?php echo Theme::Get('form_action'); ?>">
	...
	<table>
        <tr>
            ...
            <td><input name="heading" class="required" type="text" id="heading" tabindex="1" value="<?php echo Theme::Get('heading'); ?>" /></td>
        </tr>
        <tr>
            <td><label for="listcontent" accesskey="l"><?php echo Theme::Translate('List Content'); ?></label></td>
            <td><input name="listcontent" type="text" id="listcontent" tabindex="2" value="<?php echo Theme::Get('listcontent'); ?>" /></td>
        </tr>
        <tr>
            <td><label for="columnorder" accesskey="c"><?php echo Theme::Translate('Column Order'); ?></label></td>
            <td><input name="columnorder" type="text" id="columnorder" tabindex="3" value="<?php echo Theme::Get('columnorder'); ?>" /></td>
        </tr>
    </table>
</form>
