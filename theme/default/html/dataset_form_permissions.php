 ...
 * 	form_rows = Rows in this form (there are a number of groups shown)
 * 		value_view = The value for the view checkbox
 * 		value_edit = The value for the edit checkbox
 * 		value_del = The value for the delete checkbox
 * 		value_view_checked = Text "checked" or empty
 * 		value_edit_checked = Text "checked" or empty
 * 		value_del_checked = Text "checked" or empty
 */
