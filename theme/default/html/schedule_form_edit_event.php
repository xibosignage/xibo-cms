        ...
        <div class="span12">
            ...
            <table style="width:100%;">
                ...
                <tr>
                    ...
                    <td>
                        <div class="date-pick input-append date">
                            <input data-format="dd/MM/yyyy hh:mm" type="text" class="input-medium" name="starttime" id="starttime" value="<?php echo Theme::Get('starttime'); ?>"></input>
                            <span class="add-on">
                    ...
                    <td>
                        <div class="date-pick input-append date">
                            <input data-format="dd/MM/yyyy hh:mm" type="text" class="input-medium" name="endtime" id="endtime" value="<?php echo Theme::Get('endtime'); ?>"></input>
                            <span class="add-on">
                                <i data-time-icon="icon-time" data-date-icon="icon-calendar"></i>
                            </span>
                        </div>
                ...
                <tr>
                    ...
                    <td><input type="text" name="DisplayOrder" value="<?php echo Theme::Get('display_order'); ?>" />
                    ...
                    <td><input type="checkbox" id="cb_is_priority" name="is_priority" <?php echo Theme::Get('is_priority'); ?> title="<?php echo Theme::Translate('Sets whether or not this event has priority. If set the event will be show in preference to other events.'); ?>"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><?php echo Theme::SelectList('rec_type', Theme::Get('recurrence_field_list'), 'id', 'name', Theme::Get('rec_type')); ?></td>
                    ...
                    <td><input class="number" type="text" name="rec_detail" value="<?php echo Theme::Get('rec_detail'); ?>" /></td>
                </tr>
                <tr>
                    ...
                    <td><div class="date-pick input-append date">
                        <input data-format="dd/MM/yyyy hh:mm" type="text" class="input-medium" name="rec_range" id="rec_range" value="<?php echo Theme::Get('rec_range'); ?>"></input>
                        <span class="add-on">
                            <i data-time-icon="icon-time" data-date-icon="icon-calendar"></i>
                        </span>
                    </div></td>
