...
<div class="row">
	<ul class="nav nav-pills span12">
		...
		?>
		<li class="pull-right"><a title="<?php echo Theme::Translate('Add a new resolution for use on layouts'); ?>" class="XiboFormButton" href="<?php echo Theme::Get('resolution_form_add_url'); ?>" ><span><?php echo Theme::Translate('Add Resolution'); ?></span></a></li>
	</ul>
</div>
<div class="row">
