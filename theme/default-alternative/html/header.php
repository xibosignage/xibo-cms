...
<html lang="en">
    <head>
        ...
        <link href="theme/default-alternative/libraries/bootstrap/css/bootstrap.min.css" rel="stylesheet" media="screen">
        <link href="theme/default-alternative/libraries/bootstrap/css/bootstrap-theme.min.css" rel="stylesheet" media="screen">
        <link href="theme/default-alternative/libraries/font-awesome/css/font-awesome.min.css" rel="stylesheet">
        <link href="theme/default-alternative/libraries/bootstrap-select/css/bootstrap-select.css" rel="stylesheet">
        <link href="theme/default-alternative/libraries/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css" rel="stylesheet">
        <link href="theme/default-alternative/libraries/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css" rel="stylesheet">
        <link href="theme/default-alternative/libraries/bootstrap-ekko-lightbox/ekko-lightbox.min.css" rel="stylesheet">
        <link href="theme/default-alternative/libraries/calendar/css/calendar.css" rel="stylesheet">
        <link href="theme/default-alternative/libraries/morrisjs/morris.css" rel="stylesheet">
        <link href="theme/default-alternative/libraries/jquery-tablesorter/css/theme.bootstrap.css" rel="stylesheet">
        <link href="theme/default-alternative/libraries/jquery/jquery-ui/css/ui-lightness/jquery-ui-1.10.2.custom.min.css" rel="stylesheet">
        <link href="theme/default-alternative/libraries/jquery-file-upload/css/jquery.fileupload-ui.css" rel="stylesheet">
        ...
        <link href="<?php echo Theme::ItemPath('css/entypo.css'); ?>" rel="stylesheet" media="screen">
        ...
        <div class="page-container">
            ...
            <div class="sidebar-menu">
                ...
                <header class="logo-env"> 
                	<div class="logo">  <img class="xibo-logo" src='<?php echo Theme::ImageUrl('xibologo.png'); ?>'> </div>                 	
                	<div class="sidebar-mobile-menu visible-xs"> <a href="#" class="with-animation collapsed" data-toggle="collapse" data-target="#main-menu" aria-expanded="false" aria-controls="navbar"> <i class="entypo-menu"></i> </a> </div> 
                </header>
                <ul id="main-menu" class="main-menu navbar-collapse collapse">
                    <li class="opened "><div class="user pull-left">                            	 
                                <div class="item dropdown">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                        <img src="<?php echo Theme::ImageUrl('avatar.jpg'); ?>" />
                                    </a>
                                    <ul class="dropdown-menu dropdown-menu-left profile-info">
                    	...
                    	<a href="<?php echo Theme::GetUserHomeLink(); ?>"><?php echo Theme::Translate('Dashboard'); ?></a></li>
                    <?php
                        foreach (Theme::GetMenu('Top Nav') as $item) {
                            ...
                            if (empty($menu))
                                echo '<li class="root-level ' . $item['class'] . (($item['selected']) ? ' active' : '') . '"><a href="' . $item['link'] . '" class="' . $item['class'] . (($item['selected']) ? ' active' : '') . '">' . $item['title'] . '</a></li>';
                            else
                                echo '<li class="sidebar-title"><a>' . $item['title'] . '</a></li>';

                            if (!empty($menu)) {
                                foreach ($menu as $sub_item) {
                                    echo '<li class="root-level ' . $sub_item['class'] . (($sub_item['selected']) ? ' active' : '') . '"><a href="' . $sub_item['link'] . '" class="' . $sub_item['class'] . (($sub_item['selected']) ? ' active' : '') . '">' . $sub_item['title'] . '</a></li>';
                                }
                            }
                        }
                    ?>
